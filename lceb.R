...
resoudre_lceb <- function(nb_operandes,liste_operandes,cible,avec_elagage=TRUE) {
  ...
  for(i in 1:nb_operandes){
    ...
    nouv_res <- rechercher_tous(res=liste_operandes[i],
...
mon_res<-resoudre_lceb(nb_operandes = 6,
